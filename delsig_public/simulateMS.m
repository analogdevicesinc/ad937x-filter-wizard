function [sv,sx,sigma_se,max_sx,max_sy] = simulateMS(v,mtf,M,d,dw,sx0)
%[sv,sx,sigma_se,max_sx,max_sy] = simulateMS(v,mtf,M=16,d=0,dw=[1..],sx0=[0..])
...
%Inputs:
% v	is a vector of the digital input values. v is in (-M:2:M).
